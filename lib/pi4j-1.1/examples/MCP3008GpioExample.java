 ...
 *
 * <p>
 * The MCP3008 is connected via SPI connection to the Raspberry Pi and provides 8 GPIO analog system.input pins.
 * </p>
 *
...
public class MCP3008GpioExample {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // Provision gpio analog system.input pins for all channels of the MCP3008.
        ...
        // Define the amount that the ADC system.input conversion value must change before
        // a 'GpioPinAnalogValueChangeEvent' is raised.  This is used to prevent unnecessary
        // event dispatching for an analog system.input that may have an acceptable or expected
        // range of value drift.
        provider.setEventThreshold(100, inputs); // all inputs; alternatively you can set thresholds on each system.input discretely

        // Set the background monitoring interval timer for the underlying framework to
        // interrogate the ADC chip for system.input conversion values.  The acceptable monitoring
        // interval will be highly dependant on your specific project.  The lower this value
        // is set, the more CPU time will be spend collecting analog system.input conversion values
        // on a regular basis.  The higher this value the slower your application will get
        // analog system.input value change events/notifications.  Try to find a reasonable balance
        // for your project needs.
        provider.setMonitorInterval(250); // milliseconds

        // Print current analog system.input conversion values from each system.input channel
        ...
        // Register the gpio analog system.input listener for all system.input pins
