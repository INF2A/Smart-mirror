...
public class UsageGpioExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // START SNIPPET: usage-provision-system.input-pin-snippet
        ...
        // END SNIPPET: usage-provision-system.input-pin-snippet
        ...
        // create a gpio synchronization trigger on the system.input pin
        // when the system.input state changes, also set LED controlling gpio pin to same state
