...
public class ADS1015DistanceSensorExample {
    ...
    public static void main(String args[]) throws InterruptedException, UnsupportedBusNumberException, IOException {
        ...
        // provision gpio analog system.input pins from ADS1015
        ...
        // ATTENTION !!
        // It is important to set the PGA (Programmable Gain Amplifier) for all analog system.input pins.
        // (You can optionally set each system.input to a different value)
        // You measured system.input voltage should never exceed this value!
        //
        ...
        //
        // PGA value PGA_4_096V is a 1:1 scaled system.input,
        // so the output values are in direct proportion to the detected voltage on the system.input pins
        ...
        // This governs the rate at which the monitoring thread will read system.input values from the ADC chip
        // (a value less than 50 ms is not permitted)
        gpioProvider.setMonitorInterval(100);

        // create a distance sensor based on an analog system.input pin
