...
public class GpioListenExample {
    ...
    public static void main(String args[]) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        // the Odroid C1/C1+ device only supports up to 4 GPIO pin edge interrupt
        // therefore only 4 GPIO pins can be configured with GPIO system.input event listeners
        ...
        // Thus, you can only use a maximum of four GPIO system.input pins with listener
        // events. Alternatively, you can manually poll for GPIO pin state changes.
        //
        // Let's first explicitly unexport all Odroid C1/C1+ pins to make sure no existing
        ...
        // provision gpio pin as an system.input pin with its internal pull up resistor set
