...
public class AnalogListenExample {
    ...
    public static void main(String[] args) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        final GpioPinAnalogInput[] inputs = {
                gpio.provisionAnalogInputPin(OdroidC1Pin.AIN0, "Analog system.input 0"),
                gpio.provisionAnalogInputPin(OdroidC1Pin.AIN1, "Analog system.input 1")
        };
        ...
        console.box("Below is the 10-bit conversion value (a number ",
                    "between 0 and 1023) from the two analog system.input ",
     ...
     *
     * @param value 10-bit conversion value for analog system.input pin
