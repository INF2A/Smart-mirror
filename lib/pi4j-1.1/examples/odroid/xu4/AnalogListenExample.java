...
public class AnalogListenExample {
    ...
    public static void main(String[] args) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        // <OPTIONAL>
        // We can optionally override the default polling rate for the analog system.input monitoring (DEFAULT=50ms)
        // ... this is the rate at which the internal analog system.input monitoring thread will poll for changes
        ...
        // ... this is the threshold delta value that the internal analog system.input monitoring thread must cross before
        //     dispatching a new analog system.input value change event
        ...
        // provision analog system.input pins
        final GpioPinAnalogInput[] inputs = {
                gpio.provisionAnalogInputPin(OdroidXU4Pin.AIN0, "Analog system.input 0"),
                gpio.provisionAnalogInputPin(OdroidXU4Pin.AIN3, "Analog system.input 3")
        };
        ...
        console.box("Below is the 12-bit conversion value (a number ",
                    "between 0 and 4095) from the two analog system.input ",
                    "pins which represents a voltage applied to each",
                    "pin between 0VDC (Ground) and +1.8VDC.  If no ",
                    "voltage is currently applied to the analog system.input",
    ...
    /**
     * calculate relative analog system.input voltage based on the 10-bit conversion value
     * read from the hardware
     *
     * @param value 12-bit conversion value for analog system.input pin
     * @return relative voltage for analog system.input pin
     */
