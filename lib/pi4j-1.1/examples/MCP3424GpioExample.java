 ...
 * 16 GPIO pins that can be used for either digital system.input or digital output pins.
 * </p>
 *
...
public class MCP3424GpioExample {
    ...
    public static void main(String args[]) throws InterruptedException, UnsupportedBusNumberException, IOException {
        ...
        // provision gpio system.input pins from MCP3424
        ...
        provider.setEventThreshold(0, inputs); // all inputs; alternatively you can set thresholds on each system.input discretely
