...
public class GpioListenAllExample {
    ...
    public static void main(String args[]) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        // provision gpio system.input pins with its internal pull down resistor set
        ...
        // these pins must be polled for system.input state changes, these pins do not support edge detection and/or interrupts
        // provision gpio system.input pins with its internal pull resistors configured
