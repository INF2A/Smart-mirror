...
public class GpioInputExample {
    ...
    public static void main(String[] args) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        console.title("<-- The Pi4J Project -->", "GPIO system.input Example");
        ...
        // provision gpio pin as an system.input pin
        ...
        console.emptyLine();
        console.box("The GPIO system.input pin states will be displayed below.");
        console.emptyLine();
