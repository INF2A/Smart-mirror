...
public class NonPrivilegedGpioExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // set shutdown state for the system.input pin (and un-export the pin)
        ...
        // display info to user
        System.out.println("You can connect pin [" + input.getName() + "] to +3VDC to capture system.input state changes.");
