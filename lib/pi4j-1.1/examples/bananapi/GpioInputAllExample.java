...
public class GpioInputAllExample {
    ...
    public static void main(String[] args) throws InterruptedException, PlatformAlreadyAssignedException {
        ...
        console.title("<-- The Pi4J Project -->", "GPIO system.input (ALL PINS) Example");
        ...
        // provision GPIO system.input pins
        ...
        console.println(" ... Successfully provisioned all GPIO system.input pins");
        console.emptyLine();
        console.box("The GPIO system.input pins states will be displayed below.");
        console.emptyLine();
