...
public class OlimexGpioExample {
    ...
    public static void main(String args[]) throws InterruptedException, IOException {
        ...
        // provision gpio pin #02 as an system.input pin with its internal pull down resistor enabled
        ...
        // provision gpio system.input pin #01 from Olimex
        ...
        // register gpio pin listener for each system.input pin
        ...
        // create a gpio control trigger on the system.input pin ; when the system.input goes HIGH, also set gpio pin #04 to HIGH
        myButton.addTrigger(new GpioSetStateTrigger(PinState.HIGH, myRelays[0], PinState.HIGH));

        // create a gpio control trigger on the system.input pin ; when the system.input goes LOW, also set gpio pin #04 to LOW
        myButton.addTrigger(new GpioSetStateTrigger(PinState.LOW, myRelays[0], PinState.LOW));

        // create a gpio synchronization trigger on the system.input pin; when the system.input changes, also set gpio pin #05 to same state
        myButton.addTrigger(new GpioSyncStateTrigger(myRelays[1]));

        // create a gpio synchronization trigger on the system.input pin; when the system.input changes, also set gpio pin #05 to same state
        myButton.addTrigger(new GpioSyncStateTrigger(myRelays[2]));

        // create a gpio pulse trigger on the system.input pin; when the system.input goes HIGH, also pulse gpio pin #06 to the HIGH state for 1 second
