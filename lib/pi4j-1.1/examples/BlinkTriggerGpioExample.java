...
public class BlinkTriggerGpioExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // create a gpio control trigger on the system.input pin ; when the system.input goes HIGH, turn on blinking
        myButton.addTrigger(new GpioBlinkStateTrigger(PinState.HIGH, myLed, 250));

        // create a gpio control trigger on the system.input pin ; when the system.input goes LOW, turn off blinking
