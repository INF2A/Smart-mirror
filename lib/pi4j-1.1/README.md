...
2016-07-26 :: 1.1
  ...
  *  The Odroid C1/C1+/C2 only permits up to four GPIO pins to be configured with edge detection for both "rising"
     and "falling" edges (a.k.a., "both"). Thus, you can only use a maximum of four GPIO system.input pins with listener
     events.  You can, however, implement a polling strategy to read a pin state if you need more than 4 system.input pins.
...
2015-04-18 :: 1.0
  ...
  *  Added support for debounce logic on digital system.input pin events
...
2012-10-22 :: 0.0.3-SNAPSHOT
   ...
   *  Refactored Gpio interfaces to separate digital, analog, and PWM types of system.input and output pins.
